...
public class DefaultTemplateEngineProvider implements TemplateEngineProvider {
    ...
    public void configure() {
        ...
        final StrutsMessageResolver strutsMessageResolver = new StrutsMessageResolver();
        templateEngine.setMessageResolver(strutsMessageResolver);
        if(templateEngine instanceof SpringTemplateEngine){
            SpringTemplateEngine springTemplateEngine = (SpringTemplateEngine)templateEngine;
            springTemplateEngine.setMessageSource(strutsMessageResolver.getMessageSource());
        }
